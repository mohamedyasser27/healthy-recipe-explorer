...
export const SearchResultCard = ({ recipe }: { recipe: Recipe }) => {
	...
	return (
		<div
			className="group relative cursor-pointer overflow-hidden rounded-lg bg-white shadow-md transition-all duration-300 hover:-rotate-1 hover:scale-105 hover:shadow-xl"
			onClick={handleClick}
		>
